-- BoardMate Arena v11.4.21: unified game catalog + new games + Fantasy/Werewolf repair
-- Run this LAST in Supabase SQL Editor after deploying the v11.4.21 web files.
...
begin
  ...
  mode:=case
    when p_game in ('avalon','secrethitler','onenightwerewolf','quacks') then 'realtime'
    else 'turn'
  end;
