...
export const SPONSOR_CARDS = [
  // ---- 도움1.pdf ----
  { ...sponsor('콘', 3, '수입: 사파리존에 있는 물 타입 아이콘 1/3/6개마다 3/6/9 획득'), abilityKey: 'income_icon_money', abilityIconType: 'water' },
  sponsor('태홍', 5, '이어진 혜택 칸 마다 1 획득. 비어진 2칸의 혜택 칸마다 1 획득', { condition: 'max 25 appeal' }),
  { ...sponsor('털보박사', 5, '당신의 사파리존에 호연 지방 카드를 사용할 때마다 공짜로 파빌리온을 건설'), abilityKey: 'on_animal_region_free_pavilion', abilityRegion: '호연' },
  { ...sponsor('팟', 5, '수입: 사파리존에 있는 불 타입 아이콘 1/3/6개마다 3/6/9 획득'), abilityKey: 'income_icon_money', abilityIconType: 'fire' },
  { ...sponsor('풍&란', 3, '수입: 사파리존에 있는 초 타입 아이콘 1/3/6개마다 3/6/9 획득'), abilityKey: 'income_icon_money', abilityIconType: 'psychic' },
  ...
  // ---- 도움2.pdf ----
  { ...sponsor('간호순', 5, '수입: 1 획득'), abilityKey: 'income_per_break', abilityAmount: 1 },
  { ...sponsor('강연', 6, '당신이 사파리존에 불 타입 아이콘을 내려놓을 때마다 2 획득', { placement: '바위 1칸이라도 맞닿게 배치' }), abilityKey: 'on_animal_type_money', abilityIconType: 'fire', abilityAmount: 2 },
  ...
  { ...sponsor('규리', 5, '당신이 사파리존에 특수 타입 아이콘을 내려놓을 때마다 2 획득', { placement: '물 1칸이라도 맞닿게 배치' }), abilityKey: 'on_animal_type_money', abilityIconType: 'fossil', abilityAmount: 2 },
  ...
  { ...sponsor('덴트', 3, '수입: 사파리존에 있는 풀 타입 아이콘 1/3/6개마다 3/6/9 획득'), abilityKey: 'income_icon_money', abilityIconType: 'grass' },
  ...
  { ...sponsor('민지', 5, '당신이 불 타입 아이콘 카드를 내려놓을 때마다 x토큰 1개 획득'), abilityKey: 'on_animal_type_xtoken', abilityIconType: 'fire' },
  sponsor('민진', 4, '이 카드 위에 큐브 2개를 올린다. 기본 전설 카드를 달성할 때 큐브 1개로 조건 1개를 대체 가능. 전설 카드 위 큐브 5개마다 1 획득'),
  { ...sponsor('민화', 6, '당신이 풀 타입 아이콘 카드를 내려놓을 때마다 카드 더미에서 2장을 뽑아 1장을 손으로 가져오고 나머지는 버림'), abilityKey: 'on_animal_type_draw_keep1', abilityIconType: 'grass', abilityAmount: 2 },
  ...
  { ...sponsor('블레리', 5, '당신이 사파리존에 초 타입 아이콘을 내려놓을 때마다 2 획득', { placement: '바위 1칸이라도 맞닿게 배치' }), abilityKey: 'on_animal_type_money', abilityIconType: 'psychic', abilityAmount: 2 },
  sponsor('비주기', 5, '물과 바위를 덮으면서 건물을 건설할 수 있다(카드의 물/바위 필요치 무시). 물과 바위가 필요한 카드마다 2 획득'),
  sponsor('성호', 3, '서로 다른 타입 아이콘을 5개 보유했다면 1 획득'),
  { ...sponsor('수호', 5, '즉시 협회 직원 1명을 고용한다'), abilityKey: 'hire_worker' },
  sponsor('시바', 4, '모든 사파리존에서 격투 타입 아이콘이 내려질 때마다 3 획득'),
  { ...sponsor('실버', 5, '수입: x-토큰 1개 획득'), abilityKey: 'income_xtoken', abilityAmount: 1 },
  ...
  { ...sponsor('N', 4, '수입: 3 획득'), abilityKey: 'income_per_break', abilityAmount: 3 },
  ...
  { ...sponsor('자두', 3, '수입: 사파리존에 있는 격투 타입 아이콘 1/3/6개마다 3/6/9 획득'), abilityKey: 'income_icon_money', abilityIconType: 'fighting' },
