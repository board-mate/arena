# 🚦 START HERE — BoardMate Arena v11.4.79
...
**v11.4.79는 v11.4.60의 행성 X/알림 기능과 v11.4.78 Calico 규칙 수정을 유지하면서, 숨김 탭 polling·모바일 복귀 재확인·알림 평가 및 목록 요청 직렬화를 추가한 기준본입니다. PC 탭 `🔔 내 차례`/페이지 배너/브라우저 시스템 알림은 유지되며, 완전히 종료된 브라우저 대상 서버 Web Push는 범위 밖입니다.**
