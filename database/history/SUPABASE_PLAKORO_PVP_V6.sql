-- BoardMate Arena v11.4.29 — Plakoro Pokemon PvP V6 (self-contained compatibility repair)
-- Safe to run over V3/V4/V5. Existing setup/action rows are preserved.
-- V6 accepts both semantic move IDs and legacy numeric move IDs, then stores semantic IDs.
