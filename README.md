# BoardMate Arena v11.4.52 · INTEGRATED FULL + HISTORY
...
- 패키지/서비스워커 셸: **v11.4.52**
- 게임 런타임 기능 기준: v11.4.52
- 이번 v11.4.52 변경은 **행성 X 원형 게임판/원형 기록지의 섹터 방향 통일**이며 새 DB 변경은 없습니다.
...
- 행성 X: 원형 보드 이벤트, `논문` 용어, 원형/네모 기록지 전환, 이모지 각주, 참조표 하단, **원형 게임판/기록지 모두 1번 섹터가 맨 위이고 이후 시계방향**.
- 앱 아이콘: 사용자 제공 BoardMate 로고를 PWA/Apple Touch/favicon에 적용.
...
v11.4.52에는 새 SQL이 없습니다. `database/SUPABASE_CURRENT_UPDATE.sql`은 기존 BoardMate 스키마 복구/갱신용 통합 repair/update 체인입니다. 빈 프로젝트 bootstrap 전체 스키마는 아닙니다.
