...
최신 통합 릴리스는 **v11.4.35**입니다. v11.4.34 Planet X PVP를 기준으로 게임 중 **개체 규칙 참조표**, 자동 동기화 시 **페이지/내부 스크롤 위치 보존**, **공개 회의·주제 조사·시작 정보의 영문 개체/규칙 한국어 변환**, **섹터 메모 한글 개체명 표시**를 추가했습니다.

v11.4.34에서 `SUPABASE_PLANETX_PVP_V1.sql`을 이미 실행했다면 이번 패치에는 **추가 SQL이 없습니다.** 자세한 변경은 `README_V11_4_35_PLANETX_UI.md`, 배포는 `UPLOAD_TO_GITHUB_V35.md`를 참고하세요.
