...
function gameInfo(game){
  const map={
    ...
    pocketnova:{name:'포켓노바',icon:'⚡',min:2,max:4}
  };
...
async function renderLoginPage(){
  if(!onlineConfigured()){shell(`<div class="page-head"><div><h1>🔐 로그인</h1><p>Supabase 연결 후 사용할 수 있습니다.</p></div></div><div class="connection-note">config.js 설정과 v10 supabase.sql 실행이 필요합니다.</div>`);return;}
...
async function renderMulti(){
  if(!onlineConfigured()){shell(`<div class="page-head"><div><h1>🌐 다인플 · 온라인</h1><p>Supabase 연결 후 사용할 수 있습니다.</p></div></div><div class="connection-note">config.js 설정과 v10 supabase.sql 실행이 필요합니다.</div>`);return;}
